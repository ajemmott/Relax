...
public class MostrartecnicaActivity extends YouTubeBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //audio = MediaPlayer.create(MostrartecnicaActivity.this, R.raw.audiorelajante);
        //audio.start();
    ...
    private void getInfo(){
        ...
        if(getIntent().hasExtra("nombre") && getIntent().hasExtra("url_video") && getIntent().hasExtra("descripcion")){
            ...
            int id_tecnica = getIntent().getIntExtra("id_tecnica",0);
            ...
            ratingBar.setRating(db.actualizarHistorial(correo, id_tecnica));
